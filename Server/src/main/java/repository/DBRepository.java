...
public class DBRepository {
    ...
    public void initDB() {
        ...
        this.deleteAll();
        this.create(new Person("Anton","Zeigna","Austria","M"));
        this.create(new Person("Kiara","Wohlberger","Bayern","F"));
        this.create(new Person("Caesar","Zensery","Chile","M"));
        this.create(new Person("Irene","Brandstätter","Thailand","F"));
        this.create(new Person("Markus","Person","New York","M"));
        this.create(new Person("Joe","Delgardo","Italien","M"));
    }
